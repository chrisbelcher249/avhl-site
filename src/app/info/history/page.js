    ...
    <main className="bg-[#F4F7FB] text-[#000B36]">
      <section className="bg-[#000724] text-white">
        <div className="mx-auto max-w-7xl px-6 py-14 md:px-8 md:py-20">
          <Link href="/info" className="mb-8 inline-flex text-sm font-black text-white/55 transition hover:text-white">← League info</Link>
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/info/champions" className="inline-flex w-fit rounded-full bg-white px-6 py-3 text-sm font-black uppercase tracking-wide text-[#000B36] transition hover:bg-cyan-100">
                View champions
              </Link>
              <Link href="/info/history/brackets" className="inline-flex w-fit rounded-full border border-cyan-200/35 bg-cyan-200/10 px-6 py-3 text-sm font-black uppercase tracking-wide text-cyan-100 transition hover:bg-cyan-200 hover:text-[#000B36]">
                Playoff brackets
              </Link>
