    ...
    <main className="bg-white px-6 py-12 text-[#000B36] md:px-8 md:py-16">
      <section className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          <Link href="/teams" className="text-sm font-black text-[#000B36]/45 transition hover:text-[#A90117]">← Major League Teams</Link>
          <p className="mt-7 text-sm font-black uppercase tracking-[0.24em] text-[#A90117]">2026–27 Minor League</p>
