...
export default async function Home() {
  ...
  return (
    <main>
      <section className="relative min-h-screen overflow-hidden bg-[#000B36] text-white">
        ...
        <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-12 px-6 py-20 md:px-8 md:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:py-24">
          <div>
