...
export default function TeamScheduleExplorer({ teamSlug, primary, games, recordsByDate = {} }) {
      ...
      <div className="mt-8 space-y-8">
        {filteredGames.map((game) => (
          <section key={game.id} className="grid gap-3 md:grid-cols-[210px_1fr] md:items-center">
            ...
            <ScheduleGameCard game={game} recordsBySlug={recordsByDate[game.date] || {}} focusTeamSlug={teamSlug} />
          </section>
        ))}
      </div>
