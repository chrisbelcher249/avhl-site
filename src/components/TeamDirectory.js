      ...
      {division === "All" ? (
        <div className="mt-8">
          <div className="mb-5 flex items-end justify-between gap-4 border-b border-[#000B36]/10 pb-4">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.24em] text-[#A90117]">Major League Directory</p>
              <h2 className="mt-1 text-3xl font-black tracking-tight md:text-4xl">All teams A–Z</h2>
            </div>
