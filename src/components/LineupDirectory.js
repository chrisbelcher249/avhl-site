...
export default function LineupDirectory({ teams }) {
    ...
    <div>
      ...
      <div className="mt-8 space-y-14">
        {filters.slice(1).map((divisionName) => {
          ...
          return (
            <section key={divisionName} className="scroll-mt-36">
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="mt-5 flex items-center justify-between gap-3">
                        <p className="text-xs font-black uppercase tracking-wide text-[#A90117] transition group-hover:text-[#000B36]">View lineup →</p>
                        <span className="rounded-full bg-[#F4F7FB] px-2.5 py-1 text-[10px] font-black text-[#000B36]/40">{team.abbreviation}</span>
                      </div>
                    </div>
                  </Link>
                ))}
