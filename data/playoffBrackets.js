...
export const playoffBrackets = [
  {
    ...
    notes: "The inaugural playoff field used division-specific seeds plus two wild cards on each side. Series scores are restored from the official 2022–23 playoff schedule; every series was best-of-seven.",
    west: {
      name: "West Bracket",
      rounds: [
        {
          name: "Round 1",
          games: [
            { a: { team: "Las Vegas Vipers", seed: "P1", score: 4 }, b: { team: "Kansas City Metrostars", seed: "W2", score: 2 }, winner: "Las Vegas Vipers" },
            { a: { team: "Seattle Dragons", seed: "P2", score: 2 }, b: { team: "San Francisco Maniacs", seed: "P3", score: 4 }, winner: "San Francisco Maniacs" },
            { a: { team: "Denver Mountain Lions", seed: "C1", score: 3 }, b: { team: "Madison Supernovas", seed: "W1", score: 4 }, winner: "Madison Supernovas" },
            { a: { team: "Salt Lake City Scorpions", seed: "C2", score: 4 }, b: { team: "Lincoln Lumberjacks", seed: "C3", score: 3 }, winner: "Salt Lake City Scorpions" },
          ],
        },
        {
          name: "Round 2",
          games: [
            { a: { team: "Las Vegas Vipers", seed: "P1", score: 2 }, b: { team: "San Francisco Maniacs", seed: "P3", score: 4 }, winner: "San Francisco Maniacs" },
            { a: { team: "Madison Supernovas", seed: "W1", score: 3 }, b: { team: "Salt Lake City Scorpions", seed: "C2", score: 4 }, winner: "Salt Lake City Scorpions" },
          ],
        },
        {
          name: "Conference Final",
          games: [
            { a: { team: "San Francisco Maniacs", seed: "P3", score: 1 }, b: { team: "Salt Lake City Scorpions", seed: "C2", score: 4 }, winner: "Salt Lake City Scorpions" },
          ],
        },
      ],
    },
      ...
      rounds: [
        {
          name: "Round 1",
          games: [
            { a: { team: "Richmond Robbers", seed: "M1", score: 4 }, b: { team: "Brooklyn Bulldogs", seed: "W2", score: 3 }, winner: "Richmond Robbers" },
            { a: { team: "Baltimore Oceanics", seed: "M2", score: 2 }, b: { team: "Delaware Pilots", seed: "M3", score: 4 }, winner: "Delaware Pilots" },
            { a: { team: "Cleveland Demons", seed: "A1", score: 1 }, b: { team: "Atlanta Cobalts", seed: "W1", score: 4 }, winner: "Atlanta Cobalts" },
            { a: { team: "Jacksonville Blood Hounds", seed: "A2", score: 4 }, b: { team: "Tennessee Wolverines", seed: "A3", score: 1 }, winner: "Jacksonville Blood Hounds" },
          ],
        },
        {
          name: "Round 2",
          games: [
            { a: { team: "Richmond Robbers", seed: "M1", score: 4 }, b: { team: "Delaware Pilots", seed: "M3", score: 3 }, winner: "Richmond Robbers" },
            { a: { team: "Atlanta Cobalts", seed: "W1", score: 4 }, b: { team: "Jacksonville Blood Hounds", seed: "A2", score: 2 }, winner: "Atlanta Cobalts" },
          ],
        },
        {
          name: "Conference Final",
          games: [
            { a: { team: "Richmond Robbers", seed: "M1", score: 1 }, b: { team: "Atlanta Cobalts", seed: "W1", score: 4 }, winner: "Atlanta Cobalts" },
          ],
        },
      ],
    },
    final: { a: { team: "Salt Lake City Scorpions", seed: "C2", score: 4 }, b: { team: "Atlanta Cobalts", seed: "W1", score: 3 }, winner: "Salt Lake City Scorpions" },
  },
  {
    season: "2023-24",
  ...
  },
  {
    ...
    notes: "The 20-team conference format returned unchanged. Qualifier series were best-of-five; Round 1 through the League Final were best-of-seven. Series scores are restored from the official 2025–26 playoff schedule.",
    west: {
      name: "Western Conference",
      rounds: [
        {
          name: "Qualifier",
          games: [
            { a: { team: "Houston Hammerheads", seed: 8, score: 3 }, b: { team: "Portland Sea Lions", seed: 9, score: 0 }, winner: "Houston Hammerheads" },
            { a: { team: "Lincoln Lumberjacks", seed: 7, score: 0 }, b: { team: "Denver Mountain Lions", seed: 10, score: 3 }, winner: "Denver Mountain Lions" },
          ],
        },
        {
          name: "Round 1",
          games: [
            { a: { team: "San Antonio Bandits", seed: 1, score: 4 }, b: { team: "Houston Hammerheads", seed: 8, score: 1 }, winner: "San Antonio Bandits" },
            { a: { team: "Arizona Heat", seed: 4, score: 4 }, b: { team: "Memphis Cannons", seed: 5, score: 2 }, winner: "Arizona Heat" },
            { a: { team: "Seattle Dragons", seed: 2, score: 4 }, b: { team: "Denver Mountain Lions", seed: 10, score: 3 }, winner: "Seattle Dragons" },
            { a: { team: "North Dakota Bison", seed: 3, score: 1 }, b: { team: "Montana Miners", seed: 6, score: 4 }, winner: "Montana Miners" },
          ],
        },
        {
          name: "Round 2",
          games: [
            { a: { team: "San Antonio Bandits", seed: 1, score: 3 }, b: { team: "Arizona Heat", seed: 4, score: 4 }, winner: "Arizona Heat" },
            { a: { team: "Seattle Dragons", seed: 2, score: 1 }, b: { team: "Montana Miners", seed: 6, score: 4 }, winner: "Montana Miners" },
          ],
        },
        {
          name: "Conference Final",
          games: [
            { a: { team: "Arizona Heat", seed: 4, score: 1 }, b: { team: "Montana Miners", seed: 6, score: 4 }, winner: "Montana Miners" },
          ],
        },
      ],
    },
      ...
      rounds: [
        {
          name: "Qualifier",
          games: [
            { a: { team: "Indianapolis Ghosts", seed: 8, score: 0 }, b: { team: "Chicago Rockets", seed: 9, score: 3 }, winner: "Chicago Rockets" },
            { a: { team: "Raleigh Wildcats", seed: 7, score: 3 }, b: { team: "Richmond Robbers", seed: 10, score: 0 }, winner: "Raleigh Wildcats" },
          ],
        },
        {
          name: "Round 1",
          games: [
            { a: { team: "Philadelphia Destroyers", seed: 1, score: 4 }, b: { team: "Chicago Rockets", seed: 9, score: 2 }, winner: "Philadelphia Destroyers" },
            { a: { team: "Atlanta Cobalts", seed: 4, score: 4 }, b: { team: "Florida Sunshine", seed: 5, score: 0 }, winner: "Atlanta Cobalts" },
            { a: { team: "Cleveland Demons", seed: 2, score: 4 }, b: { team: "Raleigh Wildcats", seed: 7, score: 2 }, winner: "Cleveland Demons" },
            { a: { team: "Charleston Tsunami", seed: 3, score: 4 }, b: { team: "Detroit Motors", seed: 6, score: 2 }, winner: "Charleston Tsunami" },
          ],
        },
        {
          name: "Round 2",
          games: [
            { a: { team: "Philadelphia Destroyers", seed: 1, score: 4 }, b: { team: "Atlanta Cobalts", seed: 4, score: 1 }, winner: "Philadelphia Destroyers" },
            { a: { team: "Cleveland Demons", seed: 2, score: 4 }, b: { team: "Charleston Tsunami", seed: 3, score: 1 }, winner: "Cleveland Demons" },
          ],
        },
        {
          name: "Conference Final",
          games: [
            { a: { team: "Philadelphia Destroyers", seed: 1, score: 3 }, b: { team: "Cleveland Demons", seed: 2, score: 4 }, winner: "Cleveland Demons" },
          ],
        },
      ],
    },
    final: { a: { team: "Montana Miners", seed: 6, score: 2 }, b: { team: "Cleveland Demons", seed: 2, score: 4 }, winner: "Cleveland Demons" },
  },
];
